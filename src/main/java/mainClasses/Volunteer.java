...
public class Volunteer {
    ...
    public static void checkCredentialsUniqueness(String username, String email, String telephone) throws SQLException, ClassNotFoundException {
        ...
        if (usernameExists)
            throw new UsernameAlreadyRegisteredException(Resources.ERR_USERNAME_ALREADY_EXISTS + Resources.TABLE_VOLUNTEERS);
        else if (emailExists)
            throw new EmailAlreadyRegisteredException(Resources.ERR_EMAIL_ALREADY_EXISTS + Resources.TABLE_VOLUNTEERS);
        else if (telephoneExists)
            throw new TelephoneAlreadyRegisteredException(Resources.ERR_TELEPHONE_ALREADY_EXISTS + Resources.TABLE_VOLUNTEERS);
    }
